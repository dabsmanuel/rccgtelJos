...
const About = () => {
  return (
    <section className='container selection:h-screen w-11/12 m-auto about mb-8'>
      <h1 className="text-2xl lg:text-4xl text-center pb-6 font-bold text-white">
